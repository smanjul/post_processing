...
C--------------------------------------------------------------------
      ...
      double precision yp1(m1,m2),yp2(m1,m2),mod_phys(m1,m2,m3)
      integer it
      real pi
...
!  Read the matlab file
       open(1,file='mode5_iso.dat')
        do k=1,n3
        do i=1,n1
          read(1,*)(mod_phys(i,j,k),j=1,n2)
        enddo
        enddo
c
!        Transform the grid
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      open(11,file='mode5_re3400a2_5_iso.dat',status='unknown')
!      write(11,*) 'VARIABLES = "X","Y","mod"'
!      write(11,*) 'ZONE I=',n1,', J=',n2,', F=BLOCK'
      write(11,*) 'VARIABLES = "X","Y","Z","mod"'
...
c     velocita' U
      write(11,234) (((mod_phys(i,j,k),i=1,n1),j=1,n2),k=1,n3)
      close(11)
